...
const FAQContainer = styledComp.div`
    background: #F5F3FF;
    padding: 4rem 6rem;
    min-height: 90vh;
    display: flex;
    ...
    <FAQContainer>
      ...
      >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
          <Typography>What is a Payment Gateway?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            ...
            process, which is the realisation of value, and hence are seen as an
            important pillar of ecommerce.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion
      ...
      >
        <AccordionSummary aria-controls="panel2d-content" id="panel2d-header">
          <Typography>
            Do I need to pay to brisk even when there is no transaction going on
            in my business?
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      >
        <AccordionSummary aria-controls="panel5d-content" id="panel5d-header">
          <Typography>
            Is there any setup fee or annual maintainance fee that I need to pay
            regularly?
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
